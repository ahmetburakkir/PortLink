          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="inline-flex items-center bg-white dark:bg-slate-800 px-3 py-1.5 rounded-full border border-primary/20 shadow-sm">
                <span className="material-icons text-primary text-sm mr-2">settings_suggest</span>
                <span className="text-sm font-semibold">Kategori: Motor &amp; Mekanik</span>
              </div>
              <div className="inline-flex items-center bg-white dark:bg-slate-800 px-3 py-1.5 rounded-full border border-primary/20 shadow-sm">
                <span className="material-icons text-primary text-sm mr-2">location_on</span>
            ...
            <button className="text-sm text-primary hover:underline font-medium flex items-center">
              <span className="material-icons text-sm mr-1">edit</span> Filtreleri Temizle
            </button>
          </div>
        </div>
      </div>
              ...
              <div className="space-y-2">
                ...
                <label className="flex items-center gap-2 cursor-pointer hover:text-primary transition-colors">
                  ...
                  <div className="flex text-warning">
                    ...
                    <span className="material-icons text-sm">star</span>
                    <span className="material-icons text-sm">star</span>
                    <span className="material-icons text-sm text-slate-300 dark:text-slate-700">
                      star
                    </span>
                  </div>
              ...
              <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow p-5">
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="w-full md:w-48 h-32 rounded-lg bg-slate-100 dark:bg-slate-800 overflow-hidden relative">
                    <img
                      className="w-full h-full object-cover"
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuCEhnlc3uH9DDWU_-pt8m50Z0KmFoAQqVZ_S_fK_OUaVD6Jv4gYmE1afRl0WglKOe0UItPjCas_xSdSxWPCilpFkC577iV97f3tvk9bqrqi_XDX1pMOf5uhSfaglTnBIxH_Iy4KZY_zBYZZcy_wNShmEUMNkoan6duvT99sSg3eCUrCZ-voYQ1siIa1p6diHBbl9QYiyEfQJ42RtpNRktS9I9c2yOuRR0-pcK2yNGt2VNP_6H8qo92PTTn1Nq6XrcoXp-Z2bcFfF5Uo"
                      alt="Hydraulic work"
                    />
                  </div>
                  <div className="flex-1 space-y-3">
            ...
            <div>
              ...
              <div className="flex">
                ...
                <button className="bg-primary text-white px-4 rounded-r-lg hover:bg-primary/90 transition-colors">
                  <span className="material-icons text-sm pt-1">arrow_forward</span>
                </button>
              </div>
            </div>
          </div>
          <div className="mt-12 pt-8 border-t border-slate-800 text-center text-xs">
            © 2024 Portlink Maritime Marketplace. Tüm hakları saklıdır.
          </div>
        </div>
      </footer>
    </div>
