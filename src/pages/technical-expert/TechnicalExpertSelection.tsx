          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-12">
            {expertiseAreas.map((expertise) => (
              <button
                ...
                className={`group relative flex flex-col items-center p-6 rounded-xl text-center transition-all duration-300 ${
              ...
              >
                ...
                <div className={`absolute top-3 right-3 transition-opacity ${
                  selectedExpertise.includes(expertise.id) ? 'opacity-100' : 'opacity-0 group-hover:opacity-40'
                }`}>
                  <span className={`material-icons-round text-xl ${
                    selectedExpertise.includes(expertise.id) ? 'text-primary' : 'text-primary'
                  }`}>
