        ...
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-2">
            <div className="bg-primary p-1.5 rounded-lg">
              <span className="material-icons text-white">anchor</span>
            </div>
      ...
      <main className="max-w-4xl mx-auto py-8 px-4 mb-12">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-primary/5 overflow-hidden">
            ...
            <form className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-slate-700 dark:text-slate-300 flex items-center gap-1">
                    <span className="material-icons text-xs">location_on</span> Liman / Tersane Seçimi
                  </label>
                  <div className="relative">
                    <select className="w-full bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-lg py-3 px-4 focus:ring-primary focus:border-primary appearance-none">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-slate-700 dark:text-slate-300 flex items-center gap-1">
                    <span className="material-icons text-xs">directions_boat</span> Gemi Adı &amp; Tipi
                  </label>
                  <input
                    type="text"
                ...
                <div className="space-y-2 md:col-span-2">
                  <label className="text-sm font-semibold text-slate-700 dark:text-slate-300 flex items-center gap-1">
                    <span className="material-icons text-xs">schedule</span> İşin Tahmini Süresi
                  </label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="border-2 border-dashed border-primary/20 bg-primary/5 rounded-xl p-6 text-center hover:bg-primary/10 transition-colors cursor-pointer group">
                    <span className="material-icons text-4xl text-primary/40 group-hover:text-primary transition-colors mb-2">
                      cloud_upload
                    </span>
                    <p className="text-xs font-medium text-slate-600 dark:text-slate-400">
                      PDF veya DWG dosyalarını sürükleyin
                    </p>
                    <p className="text-[10px] text-slate-400 mt-1">Maksimum dosya boyutu: 25MB</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="border-2 border-dashed border-primary/20 bg-primary/5 rounded-xl p-6 text-center hover:bg-primary/10 transition-colors cursor-pointer group">
                    ...
                    <p className="text-xs font-medium text-slate-600 dark:text-slate-400">
                      Görüntüleri sürükleyin veya seçin
                    </p>
                    <p className="text-[10px] text-slate-400 mt-1">PNG, JPG, JPEG desteklenir</p>
                  </div>
                </div>
              </div>
            </form>
          ...
          <div className="p-6 bg-slate-50 dark:bg-slate-800/50 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4 w-full md:w-auto">
              <button
                type="button"
                onClick={() => navigate('/subcontractor/results')}
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-slate-900 p-4 rounded-lg border border-primary/10 flex items-start gap-3">
            <span className="material-icons text-primary/60">verified</span>
            <div>
          ...
          <div className="bg-white dark:bg-slate-900 p-4 rounded-lg border border-primary/10 flex items-start gap-3">
            <span className="material-icons text-primary/60">security</span>
            <div>
          ...
          <div className="bg-white dark:bg-slate-900 p-4 rounded-lg border border-primary/10 flex items-start gap-3">
            <span className="material-icons text-primary/60">support_agent</span>
            <div>
